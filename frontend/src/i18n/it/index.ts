const translation = {
  translation: {
    ...
    landing: {
      ...
      preview: {
        label: 'Anteprima',
        user: 'Riassumi questo report trimestrale e scrivi un’email per il team.',
        assistant:
          'Ecco un riassunto conciso con i dati principali, seguito da un’email pronta da inviare che puoi modificare.',
      },
      sections: {
        multiModel: {
          title: 'Più modelli, un unico spazio',
          description:
            'Passa da modelli veloci a modelli potenti in base all’attività, senza alternare strumenti diversi.',
        },
        knowledge: {
          title: 'La tua conoscenza, integrata',
          description:
            'Fonda le risposte sui tuoi documenti e basi di conoscenza, con citazioni precise.',
        },
        privacy: {
          title: 'Europeo per principio',
          description:
            'I tuoi dati vengono elaborati nell’UE, con privacy e conformità al centro.',
        },
      },
    },
    pricing: {
      ...
      noCap: 'Nessun limite — paghi a consumo',
      popular: 'Popolare',
      messagesPerMonth: '{{formatted}} messaggi / mese',
      cta: {
        start: 'Inizia',
        choose: 'Scegli il piano',
      },
      plans: {
        free: { name: 'Free', tagline: 'Per provare' },
        starter: { name: 'Starter', tagline: 'Uso personale abituale' },
        pro: { name: 'Pro', tagline: 'Per utenti avanzati' },
        business: { name: 'Business', tagline: 'Team e uso intensivo' },
        max: { name: 'Max', tagline: 'Massima capacità' },
        payg: { name: 'A consumo', tagline: 'Paghi solo ciò che usi' },
      },
      features: {
        modelsBasic: 'Modelli Haiku e Nova',
        modelsSonnet: 'Aggiunge Claude Sonnet',
        modelsOpus: 'Aggiunge Claude Opus',
        modelsAll: 'Tutti i modelli',
        knowledgeBases: 'Basi di conoscenza personalizzate',
        agents: 'Agenti configurabili',
        fileUpload: 'Caricamento file',
        priority: 'Accesso prioritario',
      },
    },
    payg: {
      linkLabel: 'Vedi i dettagli del pagamento a consumo',
      title: 'Pagamento a consumo',
      intro:
        'Inizia con {{count}} messaggi gratuiti ogni mese. Poi paghi solo ciò che usi: addebitato dal tuo credito prepagato in base al modello e alla lunghezza di ogni messaggio. Nessun canone mensile, nessun vincolo.',
      perks: {
        allModels: 'Accesso a tutti i modelli, incluso Claude Opus',
        noMonthlyFee: 'Nessun canone mensile: paghi solo ciò che usi',
        priority: 'Accesso prioritario nei momenti di punta',
        topUpAnytime: 'Ricarica quando vuoi; ricarica automatica opzionale',
      },
      table: {
        title: 'Cosa ottieni con il credito',
        subtitle: 'Messaggi approssimativi per ricarica, per modello.',
        model: 'Modello',
        perMessage: 'Per messaggio',
        messages: '~{{formatted}}',
        disclaimer:
          'Stime basate su una lunghezza media dei messaggi. Viene addebitato l’uso esatto di ogni messaggio, quindi i numeri reali variano in base alla dimensione. I prezzi includono il margine applicabile; prezzo finale in fase di revisione.',
      },
      models: {
        nova: 'Amazon Nova',
        haiku: 'Claude Haiku',
    ...
    consumption: {
      viewBilling: 'Vedi fatturazione e utilizzo',
      creditBalance: 'Saldo',
      messagesUsed: '{{used}} / {{limit}} messaggi',
    },
    download: {
      navLabel: 'App',
      title: 'Scarica l’app Echium AI',
      intro:
        'Usa Echium AI sul tuo telefono. Distribuiamo direttamente — senza app store.',
      android: {
        title: 'Android',
        body: 'Scarica l’app e installala direttamente sul tuo dispositivo.',
        cta: 'Scarica per Android',
        note: 'Dopo il download, apri il file e consenti le installazioni dal browser se richiesto.',
        qrShow: 'Mostra codice QR',
        qrHide: 'Nascondi codice QR',
        qrHint: 'Inquadra con il telefono per scaricare',
      },
      ios: {
        title: 'iPhone e iPad',
        body: 'Aggiungi Echium AI alla schermata Home direttamente da Safari:',
        step1: 'Apri chat.echium.ai in Safari',
        step2: 'Tocca il pulsante Condividi',
        step3: 'Tocca «Aggiungi a Home»',
      },
    },
    app: {
      name: 'EchiumAI',
