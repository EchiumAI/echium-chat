  ...
  translation: {
    ...
    auth: {
      hero: {
        title: 'Echium AI',
        subtitle:
          'Um espaço de trabalho de IA privado com chat multi-modelo, bases de conhecimento personalizadas e agentes adaptados à sua equipe.',
      },
      features: {
      ...
      origin: 'Feito em Madri · União Europeia',
      email: {
        label: 'E-mail',
    ...
    landing: {
      ...
      preview: {
        label: 'Prévia',
        user: 'Resuma este relatório trimestral e escreva um e-mail para a equipe.',
        assistant:
          'Aqui está um resumo conciso com os principais números, seguido de um e-mail pronto para enviar que você pode ajustar.',
      },
      sections: {
        multiModel: {
          title: 'Vários modelos, um só espaço',
          description:
            'Alterne entre modelos rápidos e potentes conforme a tarefa, sem precisar usar ferramentas separadas.',
        },
        knowledge: {
          title: 'Seu conhecimento, integrado',
          description:
            'Baseie as respostas nos seus próprios documentos e bases de conhecimento, com citações precisas.',
        },
        privacy: {
          title: 'Europeu por princípio',
          description:
            'Seus dados são processados na UE, com privacidade e conformidade no centro de tudo.',
        },
      },
    },
    pricing: {
      title: 'Planos e preços',
      subtitle: 'Comece grátis. Faça upgrade quando quiser. Cancele quando quiser.',
      modelLocked: 'Fora do seu plano',
      upgradeTitle: 'Faça upgrade para usar este modelo',
      upgradeBody:
        '{{model}} não está incluído no seu plano atual. Faça upgrade para desbloquear.',
      upgradeCta: 'Ver planos',
      perMonth: '/mês',
      free: 'Grátis',
      usageBased: 'Por uso',
      noCap: 'Sem limite — pague pelo uso',
      popular: 'Popular',
      messagesPerMonth: '{{formatted}} mensagens / mês',
      cta: {
        start: 'Começar',
        choose: 'Escolher plano',
      },
      plans: {
        free: { name: 'Free', tagline: 'Para experimentar' },
        starter: { name: 'Starter', tagline: 'Uso pessoal regular' },
        pro: { name: 'Pro', tagline: 'Para usuários avançados' },
        business: { name: 'Business', tagline: 'Equipes e uso intenso' },
        max: { name: 'Max', tagline: 'Máxima capacidade' },
        payg: { name: 'Pague pelo uso', tagline: 'Pague apenas pelo que usar' },
      },
      features: {
        modelsBasic: 'Modelos Haiku e Nova',
        modelsSonnet: 'Adiciona Claude Sonnet',
        modelsOpus: 'Adiciona Claude Opus',
        modelsAll: 'Todos os modelos',
        knowledgeBases: 'Bases de conhecimento personalizadas',
        agents: 'Agentes configuráveis',
    ...
    payg: {
      linkLabel: 'Ver detalhes do pagamento por uso',
      title: 'Pagamento por uso',
      intro:
        'Comece com {{count}} mensagens grátis por mês. Depois, pague apenas pelo que usar — debitado do seu saldo pré-pago conforme o modelo e o tamanho de cada mensagem. Sem mensalidade, sem fidelidade.',
      perks: {
        allModels: 'Acesso a todos os modelos, incluindo o Claude Opus',
        noMonthlyFee: 'Sem mensalidade — pague apenas pelo que usar',
        priority: 'Acesso prioritário nos horários de pico',
        topUpAnytime: 'Recarregue quando quiser; recarga automática opcional',
      },
      table: {
        title: 'O que o seu saldo oferece',
        subtitle: 'Mensagens aproximadas por recarga, por modelo.',
        model: 'Modelo',
        perMessage: 'Por mensagem',
        messages: '~{{formatted}}',
        disclaimer:
          'Estimativas com base em um tamanho médio de mensagem. Você é cobrado pelo uso exato de cada mensagem, então os números reais variam conforme o tamanho. Os preços incluem a margem aplicável; preço final sujeito a revisão.',
      },
      models: {
        nova: 'Amazon Nova',
        haiku: 'Claude Haiku',
    ...
    download: {
      ...
      android: {
        ...
        qrShow: 'Mostrar QR code',
        qrHide: 'Ocultar QR code',
        qrHint: 'Escaneie com o celular para baixar',
      },
      ios: {
        title: 'iPhone e iPad',
    ...
    app: {
      ...
      waitingResponse: 'Aguarde a resposta terminar…',
    ...
    agent: {
      ...
      tab: 'Agentes',
      new: 'Novo agente',
      noAgents: 'Ainda não há agentes. Crie um para começar.',
      startChat: 'Iniciar chat',
      deleteConfirm:
        'Excluir o agente "{{name}}"? Esta ação não pode ser desfeita. Os chats existentes são mantidos.',
      wizard: {
        title: 'Criar um agente',
        greeting:
          'Olá! Vou ajudar você a criar um agente de IA. Diga o que você gostaria que ele fizesse.',
