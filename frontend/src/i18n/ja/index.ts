...
const translation: typeof en = {
  ...
  translation: {
    ...
    pricing: {
      ...
      plans: {
        free: { name: 'Free', tagline: 'お試しに' },
        starter: { name: 'Starter', tagline: '日常的な個人利用に' },
        pro: { name: 'Pro', tagline: 'パワーユーザー向け' },
        business: { name: 'Business', tagline: 'チーム・大量利用向け' },
        max: { name: 'Max', tagline: '最大スループット' },
        payg: { name: 'Pay as you go', tagline: '使った分だけ支払い' },
      },
      features: {
        modelsBasic: 'Haiku・Novaモデル',
        modelsSonnet: 'Claude Sonnetを追加',
        modelsOpus: 'Claude Opusを追加',
        modelsAll: 'すべてのモデル',
        knowledgeBases: 'カスタムナレッジベース',
        agents: '設定可能なエージェント',
    ...
    document: {
      ...
      folderDeleteConfirm:
        'フォルダ「{{name}}」を削除しますか？中のドキュメントはルートに移動します。',
      moveTo: 'フォルダへ移動',
      removeFromFolder: 'フォルダから外す',
      noFolders: 'フォルダがまだありません。',
      share: {
        title: 'ドキュメントを共有',
        hint: 'このドキュメントを使用できるエージェントを選択します。',
        allAgents: 'すべてのエージェント',
        noAgents: 'エージェントがまだありません。',
        save: '保存',
        private: '非公開',
    ...
    agent: {
      ...
      wizard: {
        title: 'エージェントを作成',
        greeting:
          'こんにちは！AIエージェントの作成をお手伝いします。どんなことをさせたいか教えてください。',
        placeholder: '回答を入力…',
        thinking: '考え中…',
