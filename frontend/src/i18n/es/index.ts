const translation = {
  translation: {
    ...
    pricing: {
      ...
      modelLocked: 'No incluido en tu plan',
      upgradeTitle: 'Mejora tu plan para usar este modelo',
      upgradeBody:
        '{{model}} no está incluido en tu plan actual. Mejora tu plan para desbloquearlo.',
      ...
      plans: {
        free: { name: 'Free', tagline: 'Para probar' },
        starter: { name: 'Starter', tagline: 'Uso personal habitual' },
        pro: { name: 'Pro', tagline: 'Para usuarios avanzados' },
        business: { name: 'Business', tagline: 'Equipos y uso intensivo' },
        max: { name: 'Max', tagline: 'Máximo rendimiento' },
        payg: { name: 'Pago por uso', tagline: 'Paga solo por lo que usas' },
      },
      features: {
        modelsBasic: 'Modelos Haiku y Nova',
        modelsSonnet: 'Añade Claude Sonnet',
        modelsOpus: 'Añade Claude Opus',
    ...
    download: {
      navLabel: 'Apps',
      title: 'Descarga la app de Echium AI',
      intro:
        'Usa Echium AI en tu móvil. Distribuimos directamente, sin tiendas de apps.',
      android: {
        title: 'Android',
      ...
      ios: {
        title: 'iPhone y iPad',
        body: 'Instala Echium AI en tu pantalla de inicio desde Safari:',
        step1: 'Abre chat.echium.ai en Safari',
        step2: 'Toca el botón Compartir',
        step3: 'Toca «Añadir a pantalla de inicio»',
      },
    },
    app: {
      name: 'EchiumAI',
      ...
      waitingResponse: 'Espera a que termine la respuesta…',
    ...
    document: {
      ...
      folderDeleteConfirm:
        '¿Eliminar la carpeta «{{name}}»? Los documentos pasan a la raíz.',
      moveTo: 'Mover a carpeta',
      removeFromFolder: 'Quitar de la carpeta',
      noFolders: 'Aún no hay carpetas.',
      share: {
        title: 'Compartir documento',
        hint: 'Elige qué agentes pueden usar este documento.',
    ...
    agent: {
      ...
      wizard: {
        ...
        greeting:
          '¡Hola! Te ayudaré a crear un agente de IA. Cuéntame qué quieres que haga.',
