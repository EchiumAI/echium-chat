const translation = {
  translation: {
    ...
    auth: {
      ...
      origin: 'Made in Madrid · European Union',
      email: {
        label: 'Email',
    ...
    pricing: {
      ...
      plans: {
        free: { name: 'Free', tagline: 'Trying it out' },
        starter: { name: 'Starter', tagline: 'Regular personal use' },
        pro: { name: 'Pro', tagline: 'For power users' },
        business: { name: 'Business', tagline: 'Teams & heavy use' },
        max: { name: 'Max', tagline: 'Maximum throughput' },
        payg: { name: 'Pay as you go', tagline: 'Pay only for what you use' },
      },
      features: {
        modelsBasic: 'Haiku & Nova models',
        modelsSonnet: 'Adds Claude Sonnet',
        modelsOpus: 'Adds Claude Opus',
    ...
    download: {
      ...
      android: {
        title: 'Android',
        body: 'Download the app and install it directly on your device.',
        cta: 'Download for Android',
        note: 'After downloading, open the file and allow installs from your browser if prompted.',
        qrShow: 'Show QR code',
        qrHide: 'Hide QR code',
        qrHint: 'Scan with your phone to download',
      },
      ios: {
        title: 'iPhone & iPad',
        body: 'Install Echium AI to your home screen straight from Safari:',
        step1: 'Open chat.echium.ai in Safari',
    ...
    document: {
      ...
      folderDeleteConfirm:
        'Delete folder "{{name}}"? Documents inside move to the root.',
      moveTo: 'Move to folder',
      removeFromFolder: 'Remove from folder',
      noFolders: 'No folders yet.',
      share: {
        title: 'Share document',
        hint: 'Choose which agents can use this document.',
    ...
    agent: {
      ...
      edit: {
        ...
        memory: 'Memory',
        memoryHint:
          "Persistent notes the agent always remembers. Updated automatically after conversations — edit or clear it anytime.",
        save: 'Save',
      },
      deleteConfirm:
...
How would you categorize this email?`,
    ...
    button: {
      ...
      allChatsAndAgents: 'All Chats & Agents',
      done: 'Done',
      ok: 'OK',
      cancel: 'Cancel',
      back: 'Back',
