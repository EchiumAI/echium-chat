  ...
  translation: {
    auth: {
      hero: {
        title: 'Echium AI',
        subtitle:
          'Un espace de travail IA privé avec chat multi-modèle, bases de connaissances personnalisées et agents adaptés à votre équipe.',
      },
      features: {
        multiModel: 'Multi-modèle',
        knowledgeBases: 'Bases de connaissances',
        agents: 'Agents configurables',
      },
      origin: 'Conçu à Madrid · Union Européenne',
      email: {
        label: 'E-mail',
    ...
    pricing: {
      ...
      noCap: 'Sans limite — paiement à l’usage',
      popular: 'Populaire',
      messagesPerMonth: '{{formatted}} messages / mois',
      cta: {
        start: 'Commencer',
        choose: 'Choisir ce forfait',
      },
      plans: {
        free: { name: 'Free', tagline: 'Pour essayer' },
        starter: { name: 'Starter', tagline: 'Usage personnel régulier' },
        pro: { name: 'Pro', tagline: 'Pour les utilisateurs avancés' },
        business: { name: 'Business', tagline: 'Équipes et usage intensif' },
        max: { name: 'Max', tagline: 'Débit maximal' },
        payg: { name: 'Paiement à l’usage', tagline: 'Ne payez que ce que vous utilisez' },
      },
      features: {
        modelsBasic: 'Modèles Haiku et Nova',
        modelsSonnet: 'Ajoute Claude Sonnet',
        modelsOpus: 'Ajoute Claude Opus',
        modelsAll: 'Tous les modèles',
        knowledgeBases: 'Bases de connaissances personnalisées',
        agents: 'Agents configurables',
    ...
    billing: {
      title: 'Facturation et utilisation',
    ...
    consumption: {
      viewBilling: 'Voir la facturation et l’utilisation',
      creditBalance: 'Solde',
      messagesUsed: '{{used}} / {{limit}} messages',
    },
    download: {
      navLabel: 'Apps',
      title: 'Obtenez l’application Echium AI',
      intro:
        'Utilisez Echium AI sur votre téléphone. Nous distribuons directement — sans magasin d’applications.',
      android: {
        title: 'Android',
        body: 'Téléchargez l’application et installez-la directement sur votre appareil.',
        cta: 'Télécharger pour Android',
        note: 'Après le téléchargement, ouvrez le fichier et autorisez les installations depuis votre navigateur si demandé.',
        qrShow: 'Afficher le QR code',
        qrHide: 'Masquer le QR code',
        qrHint: 'Scannez avec votre téléphone pour télécharger',
      },
      ios: {
        title: 'iPhone et iPad',
        body: 'Ajoutez Echium AI à votre écran d’accueil depuis Safari :',
        step1: 'Ouvrez chat.echium.ai dans Safari',
        step2: 'Appuyez sur le bouton Partager',
        step3: 'Appuyez sur « Sur l’écran d’accueil »',
      },
    },
    app: {
      name: 'EchiumAI',
