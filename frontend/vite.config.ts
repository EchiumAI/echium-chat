  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          {
            src: '/images/echium_icon_72.png',
            sizes: '72x72',
            type: 'image/png',
          },
          {
            src: '/images/echium_icon_96.png',
            sizes: '96x96',
            type: 'image/png',
          },
          {
            src: '/images/echium_icon_128.png',
            sizes: '128x128',
            type: 'image/png',
          },
          {
            src: '/images/echium_icon_144.png',
            sizes: '144x144',
            type: 'image/png',
          },
          {
            src: '/images/echium_icon_152.png',
            sizes: '152x152',
            type: 'image/png',
          },
          {
          ...
          {
            src: '/images/echium_icon_384.png',
            sizes: '384x384',
            type: 'image/png',
          },
          {
            src: '/images/echium_icon_512.png',
            sizes: '512x512',
            type: 'image/png',
            purpose: 'maskable',
          },
